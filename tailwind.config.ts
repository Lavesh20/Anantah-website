  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom colors for Anantah theme
        'dark': {
          DEFAULT: '#030711',
          foreground: '#f8fafc',
          card: '#0f172a',
      ...
      keyframes: {
        ...
        "glow": {
          ...
          "50%": { textShadow: "0 0 20px rgba(139, 92, 246, 0.8), 0 0 30px rgba(139, 92, 246, 0.6)" }
        },
        "spin-slow": {
